...
folder = r"C:\Users\lucas\OneDrive - Johns Hopkins\AIMDL_Laser_Shock Undergrads - Automation HELIX - Automation HELIX\Automation_Paper\PDV_DATA\Velocity_shots"
...
for filename in os.listdir(folder):
    ...
    alpss_main(
        ...
        theta=0,
        delta_theta=5,
        out_files_dir=(r"C:\Users\lucas\OneDrive - Johns Hopkins\AIMDL_Laser_Shock Undergrads - Automation HELIX - Automation HELIX\Automation_Paper\PDV_DATA\output_data"),
        display_plots="no",
